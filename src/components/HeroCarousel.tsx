...
const slides = [
  ...
  },
  {
    ...
    title: "TEAM",
    titleAccent: "of Health & Medical Professionals",
    subtitle: "Decades of combined clinical expertise, refined by top-tier practice and local accreditation.",
  ...
  },
  {
    ...
    subtitle: "Advanced orthotic and prosthetic care powered by GAIT analysis and intelligent design.",
  ...
  },
  {
    ...
    eyebrow: "3D PRINTED",
    title: "CAD/CAM",
    titleAccent: "Designed Devices",
    subtitle: "Digitally scanned, precision-manufactured devices delivering superior comfort, accuracy and durability.",
    cta: "Book Your Scan Now",
  },
  {
    image: researchBackground,
    eyebrow: "SMART DESIGNS",
    title: "REAL-WORLD",
    titleAccent: "Strength",
    subtitle: "Custom mobility solutions for kids and adults — all under one roof.",
    cta: "Discover More",
  },
];
