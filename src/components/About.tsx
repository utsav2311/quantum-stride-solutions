...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-background via-background/95 to-background animate-gradient-shift bg-[length:200%_200%]"></div>
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-24 -left-24 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-blob"></div>
        <div className="absolute top-1/3 -right-24 w-96 h-96 bg-accent/10 rounded-full blur-3xl animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-24 left-1/3 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-blob animation-delay-4000"></div>
      </div>
